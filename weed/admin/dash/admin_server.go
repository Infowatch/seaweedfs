...
import (
	...
	clustermaintenance "github.com/Infowatch/seaweedfs/weed/cluster/maintenance"
	...
	_ "github.com/Infowatch/seaweedfs/weed/credential/grpc" // Register gRPC credential store
)
